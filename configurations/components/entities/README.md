...
To **save** the new Entity click <mark style="color:orange;">**#3**</mark> once (<mark style="color:red;">Do not click twice as it will duplicate the entity, wait for the page to auto refresh</mark>).&#x20;
