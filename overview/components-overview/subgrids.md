...
&#xNAN;_&#x46;or example_, in the subgrid below, it displays all the associated employee leave related to that Employee. This subgrid allows you to see and interact with these related activities without leaving the Employee record form and to add a new record you click the <mark style="color:orange;">**#1**</mark> button.
